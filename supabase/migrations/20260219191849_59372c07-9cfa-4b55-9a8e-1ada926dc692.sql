-- Fix: Empenhos are informational reserves, not actual spending.
-- saldo_disponivel = valor_dotacao + creditos - consumo_os (without empenhos)
-- credito_nao_empenhado = valor_dotacao + creditos - empenhos
