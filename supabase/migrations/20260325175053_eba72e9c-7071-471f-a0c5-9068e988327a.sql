...
-- Fix view to also exclude soft-deleted OS from consumo calculation
...
SELECT oa.id AS orcamento_id,
    ...
    GREATEST(COALESCE(emp.total_empenhos, 0::numeric) - COALESCE(osc.total_consumo_os, 0::numeric), 0::numeric) AS saldo_empenhado
