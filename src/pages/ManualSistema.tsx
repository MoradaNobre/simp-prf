...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    description:
      "Calendário unificado que integra visitas técnicas e prazos de entrega das Ordens de Serviço (orçamento e execução), com indicadores de vencimento e filtros por categoria.",
    features: [
      {
        title: "Calendário Unificado",
        description: "Visualização mensal com eventos de visitas e prazos codificados por cores.",
        details: [
          "Roxo: Visitas técnicas agendadas",
          "Laranja: Prazo de apresentação de orçamento",
          "Azul: Prazo de conclusão da execução",
          "Vermelho: Prazo vencido",
          "Amarelo: Prazo próximo ao vencimento (até 3 dias)",
          "Clique no dia para ver detalhes dos eventos",
        ],
        roles: ["Todos"],
      },
      {
        title: "Cards de Resumo",
        description: "Indicadores visuais no topo da página com contadores em tempo real.",
        details: [
          "Prazos Vencidos: OS com prazo expirado e ainda na etapa correspondente",
          "Vencendo em 3 dias: Prazos próximos ao vencimento que exigem ação",
          "Visitas Agendadas: Total de visitas técnicas pendentes de realização",
        ],
      },
      {
        title: "Abas e Filtros",
        description: "Navegação por abas (Tudo, Prazos, Visitas) com filtros contextuais.",
        details: [
          "Aba 'Tudo': Exibe todos os eventos (visitas e prazos) no calendário",
          "Aba 'Prazos': Filtra apenas prazos de orçamento e execução",
          "Aba 'Visitas': Filtra apenas visitas técnicas agendadas",
          "Filtro de prazos: Pendentes, Vencidos ou Todos",
        ],
        roles: ["Todos"],
      },
      {
        title: "Prazos de OS",
        description: "Acompanhamento dos prazos obrigatórios de orçamento e execução das OS.",
        details: [
          "Prazo de orçamento: definido ao encaminhar a OS para etapa de Orçamento",
          "Prazo de execução: definido ao autorizar a OS para Execução",
          "Ambos os prazos são campos obrigatórios nas respectivas transições",
          "Clicar no evento abre os detalhes da OS correspondente",
        ],
        roles: ["Gestor Master", "Gestor Nacional", "Gestor Regional", "Fiscal de Contrato", "Auxiliar de Fiscal"],
        tip: "Prazos vencidos são exibidos em vermelho e indicam que a OS ainda não avançou para a etapa seguinte dentro do tempo estipulado.",
      },
      {
        title: "Visitas Técnicas",
        description: "Agendamento e acompanhamento de visitas técnicas vinculadas a OS em execução.",
        details: [
          "Data e hora do agendamento",
          "Responsável técnico pela visita",
          "Descrição da atividade planejada",
          "Observações pós-visita (preenchido após realização)",
          "Status: Agendada, Realizada ou Cancelada",
          "Clicar no evento abre o diálogo de detalhes da visita",
        ],
      },
    ],
  },
